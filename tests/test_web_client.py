...
def test_deployment_scaffold_exists():
    ...
    assert "name: planora-data" in prod_compose
    assert "name: planora-backups" in prod_compose
    ...
    assert "HetznerReleaseGateway/.github/workflows/release.yml@c6a718e860991fbed89c0f6207a527eb285aad81" in deploy_workflow
