...
def main() -> int:
    ...
    lines = ["% Auto-generated by scripts/jsonl_to_latex_table.py"]
    if args.aggregate:
        lines.append("% Scenario & Requested mode & Runs & Feasible \\% & Median CP time (s) & Median penalty (base) & Median penalty (LS) & Objective retries")
        ...
        lines.append("% Scenario & #Acts & Requested mode & Final mode & CP time (s) & Status & Penalty (base) & Penalty (LS)")
        for row in rows:
