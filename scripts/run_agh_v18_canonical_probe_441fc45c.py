...
WRAPPER = REPOSITORY / "scripts/run_agh_v18_canonical_probe_441fc45c.py"
WRAPPER_WSL = f"{REPOSITORY_WSL}/scripts/run_agh_v18_canonical_probe_441fc45c.py"
AUTHORIZATION = CHAIN / (
    "agent-aghfal17-native-v18-probe-authorization-20260827T080133Z-441fc45c.json"
)
...
EXACT_HOST_COMMAND_POWERSHELL = (
    ...
    "run_agh_v18_canonical_probe_441fc45c.py' "
...
STATIC_FAILURE_RECEIPT = (
    ...
    b'"run_id":"441fc45c4497c945b5e897dae57834d3",'
...
AUTHORIZATION_BINDING: dict[str, Any] = {
    ...
    "created_at_utc": "2026-08-27T08:01:33Z",
    "instance": "agh-fal17",
