#!/usr/bin/env python3
"""Authoritative whole-launch controller for the AGH-FAL17 v15 chain.
...
SCHEMA = "planora.agh-fal17.native-v15-outer-controller.v1"
FREEZE_SCHEMA = "planora.agh-fal17.native-v15-freeze.v1"
PR_SET_PDEATHSIG = 1
...
def run_controlled(
    *,
    ...
    stdout_fd = os.memfd_create("aghfal17-v15-inner-stdout")
    stderr_fd = os.memfd_create("aghfal17-v15-inner-stderr")
    report_fd = os.memfd_create("aghfal17-v15-outer-report")
    ...
    try:
        ...
        environment = {
            ...
            "LC_ALL": "C.UTF-8",
            "TZ": "UTC",
            "AGHFAL_NATIVE_V15_OUTER_CONTROLLER": "1",
        }
