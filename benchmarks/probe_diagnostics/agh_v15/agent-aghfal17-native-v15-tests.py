#!/usr/bin/env python3
"""Focused adversarial tests for the AGH-FAL17 v15 outer control plane.
...
OUTER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-outer-controller.py"
FREEZE_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-review-freeze.json"
INVOCATIONS_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-invocations.json"
BOOTSTRAP_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-bootstrap.py"
SUPERVISOR_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-supervisor.py"
RUNNER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-runner.py"
LAUNCHER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v15-launcher.sh"
...
outer = load(OUTER_PATH, "aghfal17_native_v15_outer_tested")
