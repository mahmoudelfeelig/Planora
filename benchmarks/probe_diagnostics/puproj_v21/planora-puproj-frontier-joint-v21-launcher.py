"""Sealed v21 launcher for the memory-bounded PU-PROJ solver chain."""
...
ARTIFACT_ROOT = Path(
    "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/puproj_v21"
)
SUPERVISOR = ARTIFACT_ROOT / "planora-puproj-frontier-joint-v21-supervisor.py"
EXPECTED_SUPERVISOR_SHA256 = (
    "2fee18265d421b1d7c2a81b867bce4175ff0b657e0d6cb6f52a3f87701e8ca19"
)
REQUIRED_SEALS = (
