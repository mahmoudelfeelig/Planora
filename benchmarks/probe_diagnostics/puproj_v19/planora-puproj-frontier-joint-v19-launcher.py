"""Sealed v19 launcher that captures the supervisor before execution."""
...
ARTIFACT_ROOT = Path(
    "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/puproj_v19"
)
SUPERVISOR = ARTIFACT_ROOT / "planora-puproj-frontier-joint-v19-supervisor.py"
EXPECTED_SUPERVISOR_SHA256 = (
    "6ef096d3708352096aade8289a094a5640fff18df8994d46c5e3c96c483318f9"
)
REQUIRED_SEALS = (
