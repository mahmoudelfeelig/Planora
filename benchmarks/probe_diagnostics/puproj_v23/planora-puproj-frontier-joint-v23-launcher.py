"""Sealed v23 launcher for bounded PU-PROJ model construction."""
...
ARTIFACT_ROOT = Path(
    "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/puproj_v23"
)
SUPERVISOR = ARTIFACT_ROOT / "planora-puproj-frontier-joint-v23-supervisor.py"
EXPECTED_SUPERVISOR_SHA256 = (
    "b99eceb7d1cd55708624ad6bcb144b5b1afbab05518d88bc3e05f27751f771fe"
)
REQUIRED_SEALS = (
