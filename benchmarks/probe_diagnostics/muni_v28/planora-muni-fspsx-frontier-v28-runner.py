#!/usr/bin/env python3
"""Frozen source-only MUNI-FSPSX v28 frontier diagnostic runner.
...
RUNNER_LOADER_PROTOCOL = "planora.muni-fspsx.frontier-v28-runner-loader.v1"
...
RUNTIME_RESOURCE_PROTOCOL = (
    "planora.muni-fspsx.frontier-v28-runtime-resource-checkpoints.v1"
)
...
def load_capture_manifest(
    ...
    if globals().get("__runner_loader_protocol__") != "planora.muni-fspsx.frontier-v28-runner-loader.v1":
...
def verify_runtime_bundle(
    ...
    if binding.get("protocol") != "planora.muni-fspsx.frontier-v28-sealed-runtime.v1":
    ...
    if (
        manifest.get("schema")
        != "planora.muni-fspsx.frontier-v28-sealed-runtime.v1"
...
def admit_sealed_runtime_compile_warnings(
    ...
    return {
        "schema": "planora.muni-fspsx.frontier-v28.compile-warnings.v1",
        "status": "ADMITTED",
        "count": 2,
        "category": "DeprecationWarning",
        "message": CP_MODEL_COMPILE_WARNING_MESSAGE,
...
def run_sealed_import_probe(args: argparse.Namespace) -> int:
    ...
    payload = {
        "schema": "planora.muni-fspsx.frontier-v28.sealed-import-probe-child.v1",
        "status": "PASS",
        "input_mode": "NONE",
...
def run(args: argparse.Namespace) -> int:
    ...
    partial_payload = {
        "schema": "planora.muni-fspsx.frontier-v28.fresh-partial.v1",
    ...
    def controlled_unknown(payload: dict[str, Any]) -> int:
        payload["schema"] = (
            "planora.muni-fspsx.frontier-v28.controlled-unknown.v1"
        )
    ...
    try:
        ...
        report = {
            "schema": "planora.muni-fspsx.frontier-v28.fresh-complete.v1",
        ...
        print(
            json.dumps(
                {
                    "schema": "planora.muni-fspsx.frontier-v28.runner-result.v1",
                    "status": "COMPLETE_VALID",
                    "admissible_as_solution": True,
                    "competitor_schedule_or_result_used": False,
                    "competitor_placement_or_hint_used": False,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not args.launch:
        print(json.dumps({
            "schema": "planora.muni-fspsx.frontier-v28.runner-gate.v1",
            "status": "NOT_LAUNCHED",
