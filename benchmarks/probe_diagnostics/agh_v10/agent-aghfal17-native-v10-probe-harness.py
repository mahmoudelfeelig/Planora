#!/usr/bin/env python3
"""Outer whole-tree containment for the AGH-FAL17 v10 import-only probe."""
...
def run_contained(
    ...
    *,
    ...
    reason = "normal_exit"
    errors: list[str] = []
    stdout_fd = os.memfd_create("aghfal17-v10-probe-stdout")
    stderr_fd = os.memfd_create("aghfal17-v10-probe-stderr")
    report_fd = os.memfd_create("aghfal17-v10-probe-report")
    ...
    try:
        ...
        payload = {
            "schema": "planora.agh-fal17.native-v10-probe-harness.v1",
