#!/usr/bin/env python3
"""Exact-byte process-group supervisor for AGH-FAL17 native v10."""
...
RUNNER = Path("/tmp/agent-aghfal17-native-v10-runner.py")
GENERIC_VALIDATOR = Path("/tmp/agent-aghfal17-native-v10-generic-validator.py")
STDLIB_MANIFEST = Path("/tmp/agent-aghfal17-native-v10-stdlib.sha256")
MINIMAL_TCB_MANIFEST = Path("/tmp/agent-aghfal17-native-v10-minimal-tcb.sha256")
OFFICIAL_INSTANCE = (
    ROOT
...
EXPECTED_RUNNER_SHA256 = "a12bd626aab4d74212aa63c6c202504ec3994d200cdacf1faa53581ef6fdcf32"
EXPECTED_HASHES = {
...
EXTERNAL_LOADER_PROTOCOL = "planora.aghfal17.native-v10-supervisor-loader.v1"
RUNNER_LOADER_PROTOCOL = "planora.aghfal17.native-v10-runner-loader.v1"
REQUIRED_SEALS = (
    fcntl.F_SEAL_SEAL
    | fcntl.F_SEAL_SHRINK
    | fcntl.F_SEAL_GROW
...
runtime_binding=json.loads(os.environ["AGHFAL_NATIVE_V10_RUNTIME_BUNDLE"]); runtime_row=os.fstat(runtime_root_fd)
...
captures=json.loads(os.environ["AGHFAL_NATIVE_V10_CAPTURE_MANIFEST"]); stdlib_fd=int(captures["stdlib_manifest"]["fd"]); stdlib_row=os.fstat(stdlib_fd); stdlib_raw=os.pread(stdlib_fd,stdlib_row.st_size,0)
...
sys.dont_write_bytecode=True; filename=f"<sealed-aghfal17-native-v10-runner:{actual}>"; sys.argv=[filename,*forwarded]
namespace={"__name__":"__main__","__file__":filename,"__package__":None,"__cached__":None,"__captured_sha256__":actual,"__runner_loader_protocol__":"planora.aghfal17.native-v10-runner-loader.v1"}
...
sys.path.insert(0,f"/proc/self/fd/{runtime_root_fd}"); filename=f"<sealed-aghfal17-native-v10-generic:{actual}>"; sys.argv=[filename,*forwarded]
namespace={"__name__":"__main__","__file__":filename,"__package__":None,"__cached__":None,"__captured_sha256__":actual,"__generic_loader_protocol__":"planora.aghfal17.native-v10-generic-loader.v1"}
exec(compile(source,filename,"exec",dont_inherit=True),namespace)
'''
...
def launcher_attestation() -> dict[str, Any]:
    ...
    if (
        ...
        != "planora.aghfal17.native-v10-sealed-launcher-bootstrap.v1"
        or any(
...
def build_runtime_bundle(
    *, runtime_root_fd: int, captures: Mapping[str, Mapping[str, Any]]
    ...
    try:
        ...
        manifest = {
            "schema": "planora.aghfal17.native-v10-sealed-runtime.v1",
        ...
        binding = {
            "protocol": "planora.aghfal17.native-v10-sealed-runtime.v1",
            "root_fd": root_fd,
            "root_identity": list(root_identity),
...
def agh_child_acceptance(
    *,
    ...
    if child_exit_code == 2 and child.get("status") == "NO_RESULT":
        ...
        if (
            child.get("schema")
            != "planora.agh-fal17.native-v10-runner.v1"
    ...
    generic_claims_ok = (
        ...
        == "planora.agh-fal17.native-v10-isolated-generic-validator.v1"
    ...
    if (
        child.get("schema") != "planora.agh-fal17.native-v10-runner.v1"
        ...
        or child.get("competitor_schedule_or_result_used") is not False
        or child.get("competitor_placement_or_hint_used") is not False
        or report.get("schema") != "planora.agh-fal17.native-v10-report.v1"
...
def _private_run_directory() -> tuple[Path, int, tuple[int, int, int, int]]:
    return _private_directory("planora-aghfal17-native-v10-run")


def _private_runtime_directory() -> tuple[Path, int, tuple[int, int, int, int]]:
    return _private_directory("planora-aghfal17-native-v10-runtime")
...
def run_supervised() -> dict[str, Any]:
    ...
    try:
        ...
        scratch_dir, scratch_fd, scratch_identity = _private_directory(
            "planora-aghfal17-native-v10-scratch"
        )
        ...
        payload = {
            "schema": "planora.agh-fal17.native-v10-supervisor.v1",
            "status": status,
            "errors": errors,
            "breach": breach,
...
def sealed_import_probe_claim_predicates(
    ...
    return {
        ...
        == "planora.agh-fal17.native-v10-sealed-import-probe.v1",
...
def run_sealed_import_probe() -> dict[str, Any]:
    ...
    try:
        ...
        run_dir, run_dir_fd, run_identity = _private_directory(
            "planora-aghfal17-native-v10-import-probe"
        )
        inherited.append(run_dir_fd)
        scratch_dir, scratch_fd, scratch_identity = _private_directory(
            "planora-aghfal17-native-v10-import-probe-scratch"
        )
        inherited.append(scratch_fd)
        ...
        if not launcher_bootstrap_stable:
            errors.append("sealed_launcher_bootstrap_drift")
        payload = {
            "schema": "planora.agh-fal17.native-v10-sealed-import-supervisor.v1",
...
def main() -> int:
    if (
        ...
        raise SystemExit("direct AGH-FAL17 native v10 supervisor execution rejected")
