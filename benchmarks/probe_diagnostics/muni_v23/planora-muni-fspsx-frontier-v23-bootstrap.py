#!/usr/bin/env python3
"""Externally pinned trust root for the MUNI frontier v23 diagnostic launcher.
...
CHAIN_ROOT = Path(
    "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/muni_v23"
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not args.launch and not args.dry_run and not args.sealed_import_probe:
        print(json.dumps({
            "schema": "planora.muni-fspsx.frontier-v23.bootstrap-gate.v1",
            "status": "NOT_LAUNCHED",
