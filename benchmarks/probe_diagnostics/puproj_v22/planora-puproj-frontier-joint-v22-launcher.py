"""Sealed v22 launcher for bounded live-RSS PU-PROJ finalization."""
...
ARTIFACT_ROOT = Path(
    "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/puproj_v22"
)
SUPERVISOR = ARTIFACT_ROOT / "planora-puproj-frontier-joint-v22-supervisor.py"
EXPECTED_SUPERVISOR_SHA256 = (
    "1a097fdbd3cf6728f243cfb864136a402e7af5a5313f2c35a941b3e302198323"
)
REQUIRED_SEALS = (
