#!/usr/bin/env python3
"""Outer whole-tree containment for the AGH-FAL17 v11 import-only probe."""
...
def run_contained(
    ...
    *,
    ...
    reason = "normal_exit"
    errors: list[str] = []
    stdout_fd = os.memfd_create("aghfal17-v11-probe-stdout")
    stderr_fd = os.memfd_create("aghfal17-v11-probe-stderr")
    report_fd = os.memfd_create("aghfal17-v11-probe-report")
    ...
    try:
        ...
        payload = {
            "schema": "planora.agh-fal17.native-v11-probe-harness.v1",
