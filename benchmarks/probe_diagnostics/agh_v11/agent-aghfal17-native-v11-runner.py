...
def _load_capture_manifest(
    ...
    if globals().get("__runner_loader_protocol__") != "planora.aghfal17.native-v11-runner-loader.v1":
...
def verify_runtime_bundle(
    ...
    if binding.get("protocol") != "planora.aghfal17.native-v11-sealed-runtime.v1":
    ...
    if (
        manifest.get("schema")
        != "planora.aghfal17.native-v11-sealed-runtime.v1"
...
def execute_completion() -> tuple[int, dict[str, Any]]:
    ...
    candidate = Path(os.environ["TMPDIR"]) / "native-v11-candidate.xml"
    ...
    report = {
        "schema": "planora.agh-fal17.native-v11-report.v1",
