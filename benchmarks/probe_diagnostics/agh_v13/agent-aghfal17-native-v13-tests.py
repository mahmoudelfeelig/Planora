#!/usr/bin/env python3
"""Focused adversarial tests for the AGH-FAL17 v13 outer control plane.
...
OUTER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-outer-controller.py"
FREEZE_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-review-freeze.json"
INVOCATIONS_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-invocations.json"
BOOTSTRAP_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-bootstrap.py"
SUPERVISOR_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-supervisor.py"
RUNNER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-runner.py"
LAUNCHER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v13-launcher.sh"
...
outer = load(OUTER_PATH, "aghfal17_native_v13_outer_tested")
