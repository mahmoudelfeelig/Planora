...
if [[ "${1-}" != "--launch" && "${1-}" != "--dry-run" && "${1-}" != "--sealed-import-probe" ]]; then
  printf '%s\n' '{"schema":"planora.muni-fspsx.frontier-v27.launcher-gate.v1","status":"NOT_LAUNCHED","children_started":false,"artifacts_written":false,"required_flag":"--launch","pinned_interpreter_bootstrap_required":true}'
  exit 0
fi
...
CHAIN_ROOT = "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/muni_v27"
TCB_PATH = CHAIN_ROOT + "/planora-muni-fspsx-frontier-v27-minimal-tcb.sha256"
TCB_SHA256 = "825b4b6656b67d706499095b184e55a0fe132310e7a92c7700634e8f0b26ffea"
STDLIB_PATH = CHAIN_ROOT + "/planora-muni-fspsx-frontier-v27-stdlib.sha256"
...
supervisor_path = CHAIN_ROOT + "/planora-muni-fspsx-frontier-v27-supervisor.py"
...
scope = {
    "__name__": "__main__",
    "__package__": None,
    "__file__": "sealed:muni-v27-supervisor",
...
exec(compile(supervisor_raw, "sealed:muni-v27-supervisor", "exec", dont_inherit=True), scope)
' "$0" "$@"
