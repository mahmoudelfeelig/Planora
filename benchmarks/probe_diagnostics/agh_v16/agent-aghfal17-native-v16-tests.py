#!/usr/bin/env python3
"""Focused adversarial tests for the AGH-FAL17 v16 outer control plane.
...
OUTER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-outer-controller.py"
FREEZE_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-review-freeze.json"
INVOCATIONS_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-invocations.json"
BOOTSTRAP_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-bootstrap.py"
SUPERVISOR_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-supervisor.py"
RUNNER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-runner.py"
LAUNCHER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v16-launcher.sh"
...
outer = load(OUTER_PATH, "aghfal17_native_v16_outer_tested")
...
class V16FreezeReadinessTests(unittest.TestCase):
    ...
    def test_v16_is_review_ready_but_execution_unauthorized(self) -> None:
        self.assertEqual(
            self.freeze["status"],
