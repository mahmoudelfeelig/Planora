...
def _load_capture_manifest(
    ...
    if globals().get("__runner_loader_protocol__") != "planora.aghfal17.native-v16-runner-loader.v1":
...
def verify_runtime_bundle(
    ...
    if binding.get("protocol") != "planora.aghfal17.native-v16-sealed-runtime.v1":
    ...
    if (
        manifest.get("schema")
        != "planora.aghfal17.native-v16-sealed-runtime.v1"
...
def execute_completion() -> tuple[int, dict[str, Any]]:
    ...
    if not result.is_feasible:
        ...
        return 2, {
            "schema": "planora.agh-fal17.native-v16-runner.v1",
            "status": "NO_RESULT",
    ...
    candidate = Path(os.environ["TMPDIR"]) / "native-v16-candidate.xml"
    ...
    report = {
        "schema": "planora.agh-fal17.native-v16-report.v1",
...
def sealed_import_probe() -> dict[str, Any]:
    ...
    return {
        "schema": "planora.agh-fal17.native-v16-sealed-import-probe.v1",
        "status": "PASS",
