...
RUNNER = Path("/tmp/agent-aghfal17-native-v18-runner.py")
...
EXPECTED_RUNNER_SHA256 = "24844dc75753765def9b33abed683c2855f9f329ebf2e252e697b59bdab6070f"
EXPECTED_HASHES = {
...
def agh_child_acceptance(
    *,
    ...
    if child_exit_code == 2 and child.get("status") == "NO_RESULT":
        ...
        if (
            child.get("schema")
            != "planora.agh-fal17.native-v18-runner.v1"
