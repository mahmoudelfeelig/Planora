...
WRAPPER_PATH = ROOT / "scripts" / "run_agh_v18_canonical_probe_441fc45c.py"
...
class AuthorizationContractTests(unittest.TestCase):
    ...
    def test_consumed_no_go_receipt_is_immutable_rejected_lineage(self) -> None:
        ...
        self.assertEqual(
            receipt["errors"][:2],
            ["wrapper:FileNotFoundError", "postflight_pins:FileNotFoundError"],
        )
        predecessor = self.authorization["rejected_consumed_probe_predecessor"]
        self.assertEqual(
