#!/usr/bin/env python3
"""Frozen source-only MUNI-FSPSX v21 frontier diagnostic runner.
...
def load_capture_manifest(
    ...
    if globals().get("__runner_loader_protocol__") != "planora.muni-fspsx.frontier-v21-runner-loader.v1":
...
def verify_runtime_bundle(
    ...
    if binding.get("protocol") != "planora.muni-fspsx.frontier-v21-sealed-runtime.v1":
    ...
    if (
        manifest.get("schema")
        != "planora.muni-fspsx.frontier-v21-sealed-runtime.v1"
...
def run(args: argparse.Namespace) -> int:
    ...
    partial_payload = {
        "schema": "planora.muni-fspsx.frontier-v21.fresh-partial.v1",
    ...
    try:
        ...
        report = {
            "schema": "planora.muni-fspsx.frontier-v21.fresh-complete.v1",
        ...
        print(
            json.dumps(
                {
                    "schema": "planora.muni-fspsx.frontier-v21.runner-result.v1",
                    "status": "COMPLETE_VALID",
                    "admissible_as_solution": True,
                    "competitor_schedule_or_result_used": False,
                    "competitor_placement_or_hint_used": False,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not args.launch:
        print(json.dumps({
            "schema": "planora.muni-fspsx.frontier-v21.runner-gate.v1",
            "status": "NOT_LAUNCHED",
