...
def _load_runner() -> types.ModuleType:
    ...
    module = types.ModuleType("aghfal17_native_v12_generic_runtime")
    module.__file__ = f"<sealed-native-v12-runner:{actual}>"
...
def validate(solution_fd: int) -> dict[str, object]:
    ...
    return {
        "schema": "planora.agh-fal17.native-v12-isolated-generic-validator.v1",
...
def main() -> int:
    if globals().get("__generic_loader_protocol__") != (
        "planora.aghfal17.native-v12-generic-loader.v1"
    ):
