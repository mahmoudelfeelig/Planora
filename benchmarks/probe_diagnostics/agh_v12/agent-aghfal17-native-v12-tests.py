#!/usr/bin/env python3
"""Focused adversarial tests for the AGH-FAL17 v12 outer control plane.
...
OUTER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-outer-controller.py"
FREEZE_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-review-freeze.json"
INVOCATIONS_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-invocations.json"
BOOTSTRAP_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-bootstrap.py"
SUPERVISOR_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-supervisor.py"
RUNNER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-runner.py"
LAUNCHER_PATH = ARTIFACT_ROOT / "agent-aghfal17-native-v12-launcher.sh"
...
outer = load(OUTER_PATH, "aghfal17_native_v12_outer_tested")
