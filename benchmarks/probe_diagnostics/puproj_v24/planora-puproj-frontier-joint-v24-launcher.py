"""Sealed v24 launcher for bounded PU-PROJ model construction."""
...
ARTIFACT_ROOT = Path(
    "/mnt/d/Stuff/Projects/Sites/Planora/benchmarks/probe_diagnostics/puproj_v24"
)
SUPERVISOR = ARTIFACT_ROOT / "planora-puproj-frontier-joint-v24-supervisor.py"
EXPECTED_SUPERVISOR_SHA256 = (
    "cc0e6100d0eaac10cc746ab34fdab1d2d3f6af80fa1ed5c6bcf912a513ee453e"
)
REQUIRED_SEALS = (
