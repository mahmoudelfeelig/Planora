This section summarizes the CP-SAT formulation implemented in \texttt{core/solver\_cp\_sat.py}.
We present the model in a standard mixed 0--1 form for clarity, noting that CP-SAT internally supports integer and interval variables.
